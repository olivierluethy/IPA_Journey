function search() {
    ...
    if (!found) {
        document.getElementById("noWeeklyMatches").innerHTML="No Weekly Matches Found";
    }else{
        document.getElementById("noWeeklyMatches").innerHTML="";
    }
    ...
    if (!found) {
        document.getElementById("noDailyMatches").innerHTML="No Daily Matches Found";
    }else {
        document.getElementById("noDailyMatches").innerHTML="";
    }
}
